...
export default function Footer() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#E9FC87]/20 to-transparent z-10" />
      ...
      >
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#F2F2F2] mb-4 font-mundial">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8 mb-16">
          ...
          >
            ...
            <div className="pt-4 flex justify-center md:justify-start">
              <div className="flex items-center gap-3 text-[#F2F2F2]/70">
                <MapPin className="w-4 h-4 text-[#E9FC87]/80 flex-shrink-0" />
          ...
          <motion.div 
            ...
            variants={itemVariants}
          >
            <h4 className="text-sm font-bold text-[#E9FC87] uppercase tracking-wider mb-5 text-center md:text-left">Servicios</h4>
          ...
          <motion.div 
            ...
            variants={itemVariants}
          >
            <h4 className="text-sm font-bold text-[#E9FC87] uppercase tracking-wider mb-5 text-center md:text-left">Contacto</h4>
            <ul className="space-y-3.5 flex flex-col items-center md:items-start">
              <li>
                <a 
                  href="mailto:hola@misionary.agency"
                  className="text-[#F2F2F2]/80 hover:text-[#E9FC87] transition-all duration-300 text-sm flex items-center group"
                >
                  <Mail className="w-4 h-4 mr-2 text-[#E9FC87]/70 flex-shrink-0" />
              ...
              <li>
                <a 
                  ...
                  className="text-[#F2F2F2]/80 hover:text-[#E9FC87] transition-all duration-300 text-sm flex items-center group"
                >
                  <Phone className="w-4 h-4 mr-2 text-[#E9FC87]/70 flex-shrink-0" />
                  <span className="group-hover:translate-x-1 transition-transform duration-300">
                    +54 9 3764 609 701
                  </span>
                </a>
              </li>
              <li className="pt-5 w-full text-center md:text-left">
                <h4 className="text-xs font-semibold text-[#F2F2F2]/50 uppercase tracking-wider mb-3">Legal</h4>
              </li>
              <li>
                <a 
                  href="/terminos" 
                ...
                >
                  <FileText className="w-4 h-4 mr-2 text-[#BCB4FF]/70 flex-shrink-0" />
                  <span className="group-hover:translate-x-1 transition-transform duration-300">
